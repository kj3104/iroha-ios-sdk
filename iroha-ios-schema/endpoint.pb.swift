...
enum Iroha_Protocol_GenesisBlockApplied: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case applyFailure // = 0
  case applySuccess // = 1
  case UNRECOGNIZED(Int)
  ...
  init?(rawValue: Int) {
    switch rawValue {
    case 0: self = .applyFailure
    case 1: self = .applySuccess
    default: self = .UNRECOGNIZED(rawValue)
    }
  }
  ...
  var rawValue: Int {
    switch self {
    case .applyFailure: return 0
    case .applySuccess: return 1
    case .UNRECOGNIZED(let i): return i
    }
  }
...
struct Iroha_Protocol_ApplyGenesisBlockResponse: SwiftProtobuf.Message {
  static let protoMessageName: String = _protobuf_package + ".ApplyGenesisBlockResponse"

  var applied: Iroha_Protocol_GenesisBlockApplied = .applyFailure
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularEnumField(value: &self.applied)
      default: break
      }
    }
  }
  ...
  /// `Message` and `Message+*Additions` files.
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.applied != .applyFailure {
      try visitor.visitSingularEnumField(value: self.applied, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
}
...
extension Iroha_Protocol_GenesisBlockApplied: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "APPLY_FAILURE"),
    1: .same(proto: "APPLY_SUCCESS"),
  ]
}
...
extension Iroha_Protocol_ApplyGenesisBlockResponse: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "applied"),
  ]

  func _protobuf_generated_isEqualTo(other: Iroha_Protocol_ApplyGenesisBlockResponse) -> Bool {
    if self.applied != other.applied {return false}
    if unknownFields != other.unknownFields {return false}
    return true
  }
}
